	...
	<div class="row">
		<div class="col-12 col-lg-2 col-sm-12 col-xs-12">
        	<div class="sidebar">
	            ...
	            <a href="allloans">View All Loan Requests</a>
        ...
        <div class="col-12 col-lg-10 col-sm-12 col-xs-12">
        	...
        	<div class="pl-sm-0 pl-0 pl-lg-5">
        		<h2>Latest Loan Requests</h2>
	        		<div class="table-responsive">
						<table class="table table-bordered my-table2">
						<thead>
						<tr>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Time</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Loan ID</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">User ID</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Salary</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Request Amount</th>
					...
					<a href="allloans">
						<button type="button" class="btn btn-info btn-sm">View Approved Loan Requests</button>
					</a>
        	...
        	<div class="pl-sm-0 pl-0 pl-lg-5">
        		<h2>Messages from Customers</h2>
	        		<div class="table-responsive">
						...
						<thead>
						<tr>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Date & Time</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Account Number</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Customer Name</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Email</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Messgae</th>
							<th scope="col" bgcolor="#E6E6FA" class="text-center">Achieve</th>
						</tr>
						</thead>
						<tbody>
						...
						<tr>
							...
							<td>${msg.message}</td>
							<td>
								<a href="deletemessage?id=${msg.messageId}">
									<input type="button" class="btn btn-danger btn-sm" name="update" value="Remove">
								</a>
							</td>
						</tr>						
						</c:forEach>
				...
				<thead>
				<tr>
					<th scope="col" bgcolor="#E6E6FA" class="text-center">Employee ID</th>
					<th scope="col" bgcolor="#E6E6FA" class="text-center">Name</th>
					<th scope="col" bgcolor="#E6E6FA" class="text-center">NIC</th>
					<th scope="col" bgcolor="#E6E6FA" class="text-center">Email</th>
					<th scope="col" bgcolor="#E6E6FA" class="text-center">Address</th>
				...
				<tr>
					...
					<td>
						<c:url value="updateemployee.jsp" var="url">
